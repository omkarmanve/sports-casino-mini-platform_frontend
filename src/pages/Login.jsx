  ...
  const theme = useMemo(
    () => ({
      ...
      btn: {
        ...
        background:
          "linear-gradient(180deg, rgba(99,102,241,.35), rgba(99,102,241,.18))",
        color: "#E7EAF2",
        cursor: "pointer",
        fontWeight: 600,
        letterSpacing: 0.2,
    ...
    <div style={theme.page}>
      <div style={theme.card}>
        <div style={theme.header}>
          <h2 style={theme.title}>Login</h2>
          <p style={theme.subtitle}>Welcome back — sign in to continue</p>
        </div>
        ...
        <form onSubmit={onSubmit}>
          ...
          <input
            ...
            style={{
              ...theme.inputBase,
              ...(focus.password ? theme.inputFocus : {})
            }}
        ...
        <p style={theme.footer}>
          New user?{" "}
          <Link to="/register" style={theme.link}>Register</Link>
        </p>
      </div>
